import{i as e,n as t,t as n}from"./jsx-runtime-Dk72oS4N.js";import{t as r}from"./proxy-DtPsnYP0.js";import{A as i,B as a,C as o,D as s,F as c,G as l,H as u,L as d,N as f,O as p,Ot as m,P as h,R as g,S as _,T as v,V as y,Y as b,Z as x,at as S,c as ee,ct as te,dt as ne,g as re,h as ie,ht as C,it as ae,j as w,k as T,l as oe,mt as E,nt as se,ot as ce,s as le,st as ue,tt as D,vt as de,xt as fe,z as O}from"./index-CBfIPoaO.js";import{t as k}from"./renderMarkdown-_QdSbiZv.js";import{a as A,c as pe,d as j,i as me,l as M,n as he,o as ge,r as _e,s as ve,t as N,u as P}from"./QuizStudioPage.module-S5mpNvcD.js";var F=e(t(),1);function ye(e){let t=(0,F.useCallback)(t=>{let n=window.matchMedia(e);return n.addEventListener(`change`,t),()=>n.removeEventListener(`change`,t)},[e]),n=(0,F.useCallback)(()=>window.matchMedia(e).matches,[e]);return(0,F.useSyncExternalStore)(t,n,()=>!1)}var be=/^\s*-\s*\[([ xX])\]\s*(.*)$/,I=/^#\s+(.*)$/,L=/^##\s+(.*)$/,R=/^\s*<!--\s*points:\s*(\d+)\s*-->\s*$/,xe=/^\s*>\s?(.*)$/,z=/^\s*(```|~~~)/,B=/^---\s*$/;function V(e){if(e.length===2){let t=e.map(e=>e.text.trim().toLowerCase()).sort();if(t[0]===`false`&&t[1]===`true`)return`boolean`}return e.filter(e=>e.correct).length>1?`multi`:`single`}function Se(e){let t={...A};if(e.length===0||!B.test(e[0]))return{settings:t,nextIndex:0};let n=1;for(;n<e.length&&!B.test(e[n]);){let r=e[n].indexOf(`:`);if(r>0){let i=e[n].slice(0,r).trim(),a=e[n].slice(r+1).trim();switch(i){case`shuffleQuestions`:t.shuffleQuestions=a===`true`;break;case`shuffleOptions`:t.shuffleOptions=a===`true`;break;case`instantFeedback`:t.instantFeedback=a===`true`;break;case`passMark`:t.passMark=Number.isFinite(Number(a))?Number(a):A.passMark;break;case`timeLimitMinutes`:t.timeLimitMinutes=Number.isFinite(Number(a))?Number(a):0;break;case`theme`:t.theme=a===`dark`?`dark`:`light`}}n+=1}return{settings:t,nextIndex:Math.min(n+1,e.length)}}function H(e){let t=e.replace(/\r\n/g,`
`).split(`
