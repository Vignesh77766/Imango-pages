import{a as e,n as t,t as n}from"./jsx-runtime-D3jfb0Ew.js";import{t as r}from"./proxy-BNYNIOuR.js";import{At as i,B as a,Ct as o,Dt as s,F as c,G as l,I as u,J as d,Lt as f,M as p,N as m,O as h,P as g,Q as _,St as v,T as y,U as b,V as ee,W as te,Y as ne,_ as re,c as ie,ct as ae,ft as x,g as oe,gt as S,ht as se,it as C,l as ce,lt as le,mt as ue,nt as w,pt as de,q as T,s as fe,w as E,yt as pe,z as D}from"./index-dNp0Q1GP.js";import{t as O}from"./renderMarkdown-_QdSbiZv.js";import{a as k,c as me,d as A,i as he,l as j,n as ge,o as _e,r as ve,s as ye,t as M,u as N}from"./QuizStudioPage.module-S5mpNvcD.js";import{t as be}from"./useMediaQuery-CRqix_RL.js";import{t as xe}from"./useToasts-JdoAGSjI.js";var P=e(t(),1),Se=/^\s*-\s*\[([ xX])\]\s*(.*)$/,F=/^#\s+(.*)$/,I=/^##\s+(.*)$/,L=/^\s*<!--\s*points:\s*(\d+)\s*-->\s*$/,Ce=/^\s*>\s?(.*)$/,R=/^\s*(```|~~~)/,z=/^---\s*$/;function B(e){if(e.length===2){let t=e.map(e=>e.text.trim().toLowerCase()).sort();if(t[0]===`false`&&t[1]===`true`)return`boolean`}return e.filter(e=>e.correct).length>1?`multi`:`single`}function we(e){let t={...k};if(e.length===0||!z.test(e[0]))return{settings:t,nextIndex:0};let n=1;for(;n<e.length&&!z.test(e[n]);){let r=e[n].indexOf(`:`);if(r>0){let i=e[n].slice(0,r).trim(),a=e[n].slice(r+1).trim();switch(i){case`shuffleQuestions`:t.shuffleQuestions=a===`true`;break;case`shuffleOptions`:t.shuffleOptions=a===`true`;break;case`instantFeedback`:t.instantFeedback=a===`true`;break;case`passMark`:t.passMark=Number.isFinite(Number(a))?Number(a):k.passMark;break;case`timeLimitMinutes`:t.timeLimitMinutes=Number.isFinite(Number(a))?Number(a):0;break;case`theme`:t.theme=a===`dark`?`dark`:`light`}}n+=1}return{settings:t,nextIndex:Math.min(n+1,e.length)}}function V(e){let t=e.replace(/\r\n/g,`
`).split(`
...
`}var Ae=`Quiz Info`,je=`Single Choice`,U=`Multiple Choice`,W=`True False`,G=[`Option A`,`Option B`,`Option C`,`Option D`,`Option E`,`Option F`],Me=[`A`,`B`,`C`,`D`,`E`,`F`];function K(e){return e==null?``:String(e).trim()}function q(e){return e?`yes`:`no`}function J(e){let t=K(e).toLowerCase();return t===`yes`||t===`true`||t===`y`||t===`1`}function Ne(e){let t=e.trim().replace(/^option\s*/i,``);if(!t)return-1;let n=Me.indexOf(t[0].toUpperCase());if(n>=0)return n;let r=Number(t);return Number.isFinite(r)&&r>0?r-1:-1}function Pe(e){let t=Number(K(e));return Number.isFinite(t)&&t>0?Math.floor(t):1}function Fe(e,t){let n=K(e.Question);if(!n)return null;let r=[],i=[];if(G.forEach((t,n)=>{let a=K(e[t]);a&&(i.push(n),r.push({id:j(`o`),text:a,correct:!1}))}),r.length<2)return null;let a=K(e.Correct).split(/[,;/ ]+/).filter(Boolean);for(let e of a){let n=Ne(e),a=i.indexOf(n);if(a>=0&&(r[a].correct=!0,!t))break}return{id:j(`q`),type:t?`multi`:`single`,text:n,explanation:K(e.Explanation),points:Pe(e.Points),options:r}}function Ie(e){let t=K(e.Question);if(!t)return null;let n=J(e.Correct);return{id:j(`q`),type:`boolean`,text:t,explanation:K(e.Explanation),points:Pe(e.Points),options:[{id:j(`o`),text:`True`,correct:n},{id:j(`o`),text:`False`,correct:!n}]}}function Le(e){let t=new Map;for(let n of e){let e=K(n.Field).toLowerCase();e&&t.set(e,K(n.Value))}let n=Number(t.get(`pass mark (%)`)),r=Number(t.get(`time limit (minutes)`));return{title:t.get(`title`)||`Untitled Quiz`,description:t.get(`description`)??``,settings:{...k,passMark:Number.isFinite(n)?Math.min(100,Math.max(0,n)):k.passMark,timeLimitMinutes:Number.isFinite(r)&&r>0?Math.floor(r):0,shuffleQuestions:J(t.get(`shuffle questions`)),shuffleOptions:J(t.get(`shuffle options`)),instantFeedback:J(t.get(`instant feedback`)),theme:(t.get(`theme`)??``).toLowerCase()===`dark`?`dark`:`light`}}}async function Re(e){let t=await f(()=>import(`./xlsx-BKER4Xe2.js`),[]),n=t.read(await e.arrayBuffer(),{type:`array`}),r=e=>{let r=n.Sheets[e];return r?t.utils.sheet_to_json(r,{defval:``}):[]},{title:i,description:a,settings:o}=Le(r(Ae));return{title:i,description:a,settings:o,questions:[...r(je).map(e=>Fe(e,!1)),...r(U).map(e=>Fe(e,!0)),...r(W).map(Ie)].filter(e=>e!==null)}}async function ze(e){let t=await f(()=>import(`./xlsx-BKER4Xe2.js`),[]),n=e??null,r=n?.settings??k,i=t.utils.book_new(),a=[{Field:`Title`,Value:n?.title??`My Quiz`},{Field:`Description`,Value:n?.description??`A short description of the quiz`},{Field:`Pass mark (%)`,Value:r.passMark},{Field:`Time limit (minutes)`,Value:r.timeLimitMinutes},{Field:`Shuffle questions`,Value:q(r.shuffleQuestions)},{Field:`Shuffle options`,Value:q(r.shuffleOptions)},{Field:`Instant feedback`,Value:q(r.instantFeedback)},{Field:`Theme`,Value:r.theme}],o=t.utils.json_to_sheet(a);o[`!cols`]=[{wch:22},{wch:46}],t.utils.book_append_sheet(i,o,Ae);let s=(e,t)=>{if(!e)return t;let n={Question:e.text};return G.forEach((t,r)=>{n[t]=e.options[r]?.text??``}),n.Correct=e.options.map((e,t)=>e.correct?Me[t]:null).filter(Boolean).join(`, `),n.Points=e.points,n.Explanation=e.explanation,n},c={Question:`What does typeof null return in JavaScript?`,"Option A":`"null"`,"Option B":`"object"`,"Option C":`"undefined"`,"Option D":`"number"`,"Option E":``,"Option F":``,Correct:`B`,Points:1,Explanation:`A long-standing quirk kept for backwards compatibility.`},l={Question:`Which of these are valid variable declarations?`,"Option A":`let x = 1;`,"Option B":`const x = 1;`,"Option C":`var x = 1;`,"Option D":`variable x = 1;`,"Option E":``,"Option F":``,Correct:`A, B, C`,Points:2,Explanation:`Separate multiple answers with commas.`},u={Question:`Arrays in JavaScript have a fixed length.`,Correct:`FALSE`,Points:1,Explanation:`Arrays are dynamic — push and splice resize them.`},d=n?.questions.filter(e=>e.type===`single`)??[],p=n?.questions.filter(e=>e.type===`multi`)??[],m=n?.questions.filter(e=>e.type===`boolean`)??[],h=d.length?d.map(e=>s(e,c)):[c],g=p.length?p.map(e=>s(e,l)):[l],_=m.length?m.map(e=>({Question:e.text,Correct:e.options.find(e=>e.correct)?.text.toUpperCase()??`TRUE`,Points:e.points,Explanation:e.explanation})):[u],v=[{wch:52},...G.map(()=>({wch:20})),{wch:12},{wch:8},{wch:40}],y=t.utils.json_to_sheet(h,{header:[`Question`,...G,`Correct`,`Points`,`Explanation`]});y[`!cols`]=v,t.utils.book_append_sheet(i,y,je);let b=t.utils.json_to_sheet(g,{header:[`Question`,...G,`Correct`,`Points`,`Explanation`]});b[`!cols`]=v,t.utils.book_append_sheet(i,b,U);let ee=t.utils.json_to_sheet(_,{header:[`Question`,`Correct`,`Points`,`Explanation`]});ee[`!cols`]=[{wch:52},{wch:12},{wch:8},{wch:40}],t.utils.book_append_sheet(i,ee,W);let te=t.write(i,{bookType:`xlsx`,type:`array`});return new Blob([te],{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`})}var Be=`imango-quiz-studio-library`;function Ve(e){return e.createdAt??e.savedAt??``}function Y(){try{let e=localStorage.getItem(Be);if(!e)return[];let t=JSON.parse(e);return Array.isArray(t)?t.flatMap(e=>{if(!e||typeof e.id!=`string`)return[];let t=N(e.quiz);return t?[{id:e.id,createdAt:e.createdAt,savedAt:e.savedAt,quiz:t}]:[]}):[]}catch{return[]}}function X(e){try{return localStorage.setItem(Be,JSON.stringify(e)),!0}catch{return!1}}function Z(){return Y().sort((e,t)=>{let n=Ve(t).localeCompare(Ve(e));return n===0?t.id.localeCompare(e.id):n})}function He(e,t){let n=Y(),r=t?n.find(e=>e.id===t):void 0,i=new Date().toISOString(),a={id:r?r.id:j(`quiz`),createdAt:r?r.createdAt??r.savedAt??i:i,savedAt:i,quiz:e},o=n.findIndex(e=>e.id===a.id);return o>=0?n[o]=a:n.push(a),X(n)?a:null}function Ue(e){X(Y().filter(t=>t.id!==e))}function We(e){let t=Y(),n=t.find(t=>t.id===e);if(!n)return null;let r=new Date().toISOString(),i={id:j(`quiz`),createdAt:r,savedAt:r,quiz:{...n.quiz,title:`${n.quiz.title} (copy)`}};return t.push(i),X(t)?i:null}function Ge(e,t){let n=Y(),r=n.find(t=>t.id===e);r&&(r.quiz={...r.quiz,title:t},r.savedAt=new Date().toISOString(),X(n))}function Q(e){let t=[];e.text.trim()||t.push({questionId:e.id,severity:`warning`,message:`Question text is empty`}),e.options.length<2&&t.push({questionId:e.id,severity:`error`,message:`Needs at least 2 options`}),e.options.some(e=>e.correct)||t.push({questionId:e.id,severity:`error`,message:`No correct answer marked`}),e.options.some(e=>!e.text.trim())&&t.push({questionId:e.id,severity:`warning`,message:`Has an empty option`});let n=new Set;for(let r of e.options){let i=r.text.trim().toLowerCase();if(i&&n.has(i)){t.push({questionId:e.id,severity:`warning`,message:`Has duplicate options`});break}n.add(i)}return t}function Ke(e){let t=[];e.title.trim()||t.push({questionId:null,severity:`warning`,message:`Quiz has no title`}),e.questions.length===0&&t.push({questionId:null,severity:`error`,message:`Quiz has no questions`});for(let n of e.questions)t.push(...Q(n));return t}function qe(e){return{errors:e.filter(e=>e.severity===`error`).length,warnings:e.filter(e=>e.severity===`warning`).length}}var Je=[{keys:`Ctrl / ⌘ + S`,label:`Save quiz to browser`},{keys:`Ctrl / ⌘ + O`,label:`Open my quizzes`},{keys:`Ctrl / ⌘ + ⇧ + S`,label:`Download as .md`},{keys:`Ctrl / ⌘ + E`,label:`Export as .html`},{keys:`Ctrl / ⌘ + P`,label:`Toggle preview`},{keys:`Ctrl / ⌘ + M`,label:`Edit markdown source`},{keys:`Ctrl / ⌘ + Enter`,label:`New question`},{keys:`Ctrl / ⌘ + D`,label:`Duplicate question`},{keys:`Alt + ↑ / ↓`,label:`Move question up / down`},{keys:`Alt + ← / →`,label:`Previous / next question`},{keys:`?`,label:`Keyboard shortcuts`},{keys:`Esc`,label:`Close dialog`}];function Ye(e){return e instanceof HTMLElement?e.tagName===`INPUT`||e.tagName===`TEXTAREA`||e.tagName===`SELECT`||e.isContentEditable:!1}function Xe(e){(0,P.useEffect)(()=>{let t=t=>{let n=t.ctrlKey||t.metaKey;if(t.key===`Escape`){e.onCloseOverlay();return}if(!(n&&t.altKey)){if(n){let n=t.key.toLowerCase();n===`s`?(t.preventDefault(),t.shiftKey?e.onDownloadMarkdown():e.onSave()):n===`o`?(t.preventDefault(),e.onOpenLibrary()):n===`e`?(t.preventDefault(),e.onExport()):n===`p`?(t.preventDefault(),e.onTogglePreview()):n===`m`?(t.preventDefault(),e.onToggleMarkdown()):n===`d`?(t.preventDefault(),e.onDuplicate()):t.key===`Enter`&&(t.preventDefault(),e.onNewQuestion());return}if(t.altKey&&t.key===`ArrowUp`){t.preventDefault(),e.onMoveUp();return}if(t.altKey&&t.key===`ArrowDown`){t.preventDefault(),e.onMoveDown();return}if(t.altKey&&t.key===`ArrowLeft`){t.preventDefault(),e.onPrevQuestion();return}if(t.altKey&&t.key===`ArrowRight`){t.preventDefault(),e.onNextQuestion();return}t.key===`?`&&!Ye(t.target)&&(t.preventDefault(),e.onHelp())}};return window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e])}var $=n();function Ze({quiz:e,selectedId:t,issues:n,onSelect:r,onAddQuestion:i,onDownloadSample:a,onDownloadExcelTemplate:o,onUploadClick:s,onLoadSample:c,onReorder:l}){let[u,f]=(0,P.useState)(``),[p,m]=(0,P.useState)(null),[h,g]=(0,P.useState)(null),_=(0,P.useMemo)(()=>{let e=new Map;for(let t of n){if(!t.questionId)continue;let n=e.get(t.questionId)??{errors:0,warnings:0};t.severity===`error`?n.errors+=1:n.warnings+=1,e.set(t.questionId,n)}return e},[n]),y=(0,P.useMemo)(()=>{let t=u.trim().toLowerCase();return e.questions.map((e,t)=>({question:e,index:t})).filter(({question:e})=>!t||e.text.toLowerCase().includes(t))},[e.questions,u]);return(0,$.jsxs)(`div`,{className:M.sidebarInner,children:[(0,$.jsxs)(`div`,{className:M.sidebarSection,children:[(0,$.jsxs)(`button`,{type:`button`,className:M.sidebarBtn,onClick:s,children:[(0,$.jsx)(te,{size:16}),`Upload .md or Excel`]}),(0,$.jsxs)(`button`,{type:`button`,className:M.sidebarBtn,onClick:a,children:[(0,$.jsx)(b,{size:16}),`Sample .md`]}),(0,$.jsxs)(`button`,{type:`button`,className:M.sidebarBtn,onClick:o,children:[(0,$.jsx)(v,{size:16}),`Excel template`]}),(0,$.jsxs)(`button`,{type:`button`,className:M.sidebarBtn,onClick:c,children:[(0,$.jsx)(S,{size:16}),`Load example quiz`]})]}),(0,$.jsx)(`div`,{className:M.sidebarDivider}),(0,$.jsxs)(`div`,{className:M.sidebarHeaderRow,children:[(0,$.jsxs)(`span`,{children:[`Questions (`,e.questions.length,`)`]}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:i,title:`Add question`,children:(0,$.jsx)(x,{size:15})})]}),e.questions.length>4&&(0,$.jsxs)(`div`,{className:M.sidebarSearch,children:[(0,$.jsx)(C,{size:14}),(0,$.jsx)(`input`,{type:`text`,value:u,onChange:e=>f(e.target.value),placeholder:`Filter questions`,"aria-label":`Filter questions`})]}),(0,$.jsxs)(`div`,{className:M.questionList,children:[y.length===0&&(0,$.jsx)(`p`,{className:M.sidebarEmpty,children:e.questions.length===0?`No questions yet`:`No matches`}),y.map(({question:e,index:n})=>{let i=_.get(e.id),a=e.text.split(`
`)[0].replace(/[`*_#]/g,``).trim(),o=[M.questionListItem,t===e.id?M.questionListItemActive:``,p===n?M.questionListItemDragging:``,h===n&&p!==null&&p!==n?M.questionListItemDropTarget:``].filter(Boolean).join(` `);return(0,$.jsxs)(`button`,{type:`button`,draggable:!u.trim(),className:o,onClick:()=>r(e.id),onDragStart:e=>{e.stopPropagation(),e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`text/plain`,String(n)),m(n)},onDragOver:e=>{p!==null&&(e.preventDefault(),e.stopPropagation(),e.dataTransfer.dropEffect=`move`,g(n))},onDrop:e=>{p!==null&&(e.preventDefault(),e.stopPropagation(),p!==n&&l(p,n),m(null),g(null))},onDragEnd:()=>{m(null),g(null)},children:[(0,$.jsx)(E,{size:13,className:M.dragHandle}),(0,$.jsx)(`span`,{className:M.questionListIndex,children:n+1}),(0,$.jsx)(`span`,{className:M.questionListLabel,children:a||`Untitled question`}),i&&i.errors>0&&(0,$.jsx)(d,{size:14,className:M.issueIconError}),i&&i.errors===0&&i.warnings>0&&(0,$.jsx)(d,{size:14,className:M.issueIconWarning})]},e.id)})]})]})}var Qe=[{value:`single`,label:`Single choice`,hint:`One correct answer`},{value:`multi`,label:`Multiple choice`,hint:`Several correct answers`},{value:`boolean`,label:`True / False`,hint:`Two fixed options`}];function $e({question:e,index:t,total:n,onChange:r,onDelete:i,onDuplicate:a,onMove:s,onNavigate:f}){let[p,h]=(0,P.useState)(!1),_=(0,P.useMemo)(()=>Q(e),[e]),v=(0,P.useMemo)(()=>O(e.text),[e.text]),y=t=>{if(t===`boolean`){r({...e,type:t,options:[{id:j(`o`),text:`True`,correct:!0},{id:j(`o`),text:`False`,correct:!1}]});return}if(t===`single`){let n=!1,i=e.options.map(e=>e.correct&&!n?(n=!0,e):{...e,correct:!1});r({...e,type:t,options:i});return}r({...e,type:t})},b=(t,n)=>{r({...e,options:e.options.map(e=>e.id===t?{...e,text:n}:e)})},ee=t=>{e.type===`multi`?r({...e,options:e.options.map(e=>e.id===t?{...e,correct:!e.correct}:e)}):r({...e,options:e.options.map(e=>({...e,correct:e.id===t}))})},te=()=>r({...e,options:[...e.options,{id:j(`o`),text:``,correct:!1}]}),re=t=>r({...e,options:e.options.filter(e=>e.id!==t)}),ie=(t,n)=>{let i=t+n;if(i<0||i>=e.options.length)return;let a=[...e.options];[a[t],a[i]]=[a[i],a[t]],r({...e,options:a})};return(0,$.jsxs)(`div`,{className:M.questionEditor,children:[(0,$.jsxs)(`div`,{className:M.editorHeader,children:[(0,$.jsxs)(`div`,{className:M.editorHeaderLeft,children:[f&&(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:()=>f(-1),disabled:t===0,title:`Previous question (Alt + ←)`,children:(0,$.jsx)(g,{size:16})}),(0,$.jsxs)(`span`,{className:M.editorBadge,children:[`Question `,t+1]}),(0,$.jsxs)(`span`,{className:M.editorCount,children:[`of `,n]}),f&&(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:()=>f(1),disabled:t===n-1,title:`Next question (Alt + →)`,children:(0,$.jsx)(c,{size:16})})]}),(0,$.jsxs)(`div`,{className:M.editorHeaderActions,children:[(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:()=>s(-1),disabled:t===0,title:`Move up (Alt + ↑)`,children:(0,$.jsx)(u,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:()=>s(1),disabled:t===n-1,title:`Move down (Alt + ↓)`,children:(0,$.jsx)(m,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:a,title:`Duplicate (Ctrl/⌘ + D)`,children:(0,$.jsx)(l,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtnDanger,onClick:i,title:`Delete question`,children:(0,$.jsx)(o,{size:16})})]})]}),_.length>0&&(0,$.jsx)(`ul`,{className:M.issueList,children:_.map((e,t)=>(0,$.jsxs)(`li`,{className:e.severity===`error`?M.issueError:M.issueWarning,children:[(0,$.jsx)(d,{size:13}),e.message]},t))}),(0,$.jsxs)(`div`,{className:M.fieldRow,children:[(0,$.jsxs)(`label`,{className:M.fieldLabel,children:[`Type`,(0,$.jsx)(`select`,{value:e.type,onChange:e=>y(e.target.value),className:M.select,children:Qe.map(e=>(0,$.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,$.jsxs)(`label`,{className:M.fieldLabel,children:[`Points`,(0,$.jsx)(`input`,{type:`number`,min:1,value:e.points,onChange:t=>r({...e,points:Math.max(1,Number(t.target.value)||1)}),className:M.numberInput})]})]}),(0,$.jsxs)(`div`,{className:M.fieldBlock,children:[(0,$.jsxs)(`div`,{className:M.fieldLabelRow,children:[(0,$.jsx)(`span`,{className:M.fieldLabelText,children:`Question`}),(0,$.jsxs)(`button`,{type:`button`,className:M.ghostBtn,onClick:()=>h(e=>!e),children:[(0,$.jsx)(ne,{size:14}),p?`Hide render`:`Show render`]})]}),(0,$.jsx)(`textarea`,{value:e.text,onChange:t=>r({...e,text:t.target.value}),placeholder:"Ask something... Markdown and ``` code blocks are supported",className:M.questionTextarea}),p&&e.text.trim()&&(0,$.jsx)(`div`,{className:M.inlineRender,dangerouslySetInnerHTML:{__html:v}})]}),(0,$.jsxs)(`div`,{className:M.fieldBlock,children:[(0,$.jsxs)(`span`,{className:M.fieldLabelText,children:[`Answers`,(0,$.jsx)(`span`,{className:M.fieldHint,children:e.type===`multi`?`Tick every correct answer`:`Pick the correct answer`})]}),(0,$.jsx)(`div`,{className:M.optionsList,children:e.options.map((t,n)=>(0,$.jsxs)(`div`,{className:`${M.optionRow} ${t.correct?M.optionRowCorrect:``}`,children:[(0,$.jsx)(`input`,{type:e.type===`multi`?`checkbox`:`radio`,checked:t.correct,onChange:()=>ee(t.id),"aria-label":`Mark as correct`}),e.type===`boolean`?(0,$.jsx)(`span`,{className:M.booleanLabel,children:t.text}):(0,$.jsx)(`input`,{type:`text`,value:t.text,onChange:e=>b(t.id,e.target.value),placeholder:`Option ${n+1}`,className:M.optionInput}),e.type!==`boolean`&&(0,$.jsxs)(`div`,{className:M.optionActions,children:[(0,$.jsx)(`button`,{type:`button`,className:M.iconBtnSmall,onClick:()=>ie(n,-1),disabled:n===0,title:`Move up`,children:(0,$.jsx)(u,{size:13})}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtnSmall,onClick:()=>ie(n,1),disabled:n===e.options.length-1,title:`Move down`,children:(0,$.jsx)(m,{size:13})}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtnSmall,onClick:()=>re(t.id),disabled:e.options.length<=2,title:`Remove option`,children:(0,$.jsx)(o,{size:13})})]})]},t.id))}),e.type!==`boolean`&&(0,$.jsxs)(`button`,{type:`button`,className:M.addOptionBtn,onClick:te,children:[(0,$.jsx)(x,{size:14}),`Add option`]})]}),(0,$.jsxs)(`div`,{className:M.fieldBlock,children:[(0,$.jsxs)(`span`,{className:M.fieldLabelText,children:[(0,$.jsx)(w,{size:14}),`Explanation`,(0,$.jsx)(`span`,{className:M.fieldHint,children:`Shown after answering`})]}),(0,$.jsx)(`textarea`,{value:e.explanation,onChange:t=>r({...e,explanation:t.target.value}),placeholder:`Optional: explain why the answer is correct`,className:M.explanationTextarea})]})]})}function et({quiz:e,issues:t,expandedId:n,onToggle:r,onChange:i,onDelete:a,onDuplicate:o,onMove:s,onAddQuestion:c}){return(0,$.jsxs)(`div`,{className:M.accordionList,children:[e.questions.map((c,l)=>{let u=c.id===n,f=t.filter(e=>e.questionId===c.id),p=f.some(e=>e.severity===`error`),h=f.some(e=>e.severity===`warning`),g=c.text.split(`
`)[0].replace(/[`*_#]/g,``).trim();return(0,$.jsxs)(`div`,{className:M.accordionItem,children:[(0,$.jsxs)(`button`,{type:`button`,className:M.accordionSummary,onClick:()=>r(c.id),"aria-expanded":u,children:[(0,$.jsx)(`span`,{className:M.questionListIndex,children:l+1}),(0,$.jsx)(`span`,{className:M.accordionSummaryText,children:g||`Untitled question`}),p&&(0,$.jsx)(d,{size:15,className:M.issueIconError}),!p&&h&&(0,$.jsx)(d,{size:15,className:M.issueIconWarning}),(0,$.jsx)(m,{size:16,className:`${M.accordionChevron} ${u?M.accordionChevronOpen:``}`})]}),u&&(0,$.jsx)(`div`,{className:M.accordionBody,children:(0,$.jsx)($e,{question:c,index:l,total:e.questions.length,onChange:e=>i(c.id,e),onDelete:()=>a(c.id),onDuplicate:()=>o(c.id),onMove:e=>s(c.id,e)})})]},c.id)}),(0,$.jsxs)(`button`,{type:`button`,className:M.accordionAddBtn,onClick:c,children:[(0,$.jsx)(x,{size:16}),`Add question`]})]})}function tt(e){let t=e+1831565813;return()=>(t=Math.imul(t^t>>>15,t|1),t^=t+Math.imul(t^t>>>7,t|61),((t^t>>>14)>>>0)/4294967296)}function nt(e,t){let n=[...e];for(let e=n.length-1;e>0;--e){let r=Math.floor(t()*(e+1));[n[e],n[r]]=[n[r],n[e]]}return n}function rt(e,t){let n=e.options.filter(e=>e.correct).map(e=>e.id).sort(),r=[...t].sort();return n.length>0&&r.length===n.length&&r.every((e,t)=>e===n[t])}function it(e){return`${Math.floor(e/60)}:${(e%60).toString().padStart(2,`0`)}`}function at({quiz:e}){let[t,n]=(0,P.useState)(0),[r,i]=(0,P.useState)({}),[a,o]=(0,P.useState)(!1),[s,c]=(0,P.useState)(()=>Date.now()),[l,u]=(0,P.useState)(()=>Date.now()),d=e.settings.timeLimitMinutes*60,f=(0,P.useMemo)(()=>{let n=tt(t+1),r=e.settings.shuffleQuestions?nt(e.questions,n):e.questions;return e.settings.shuffleOptions?r.map(e=>({...e,options:nt(e.options,n)})):r},[e.questions,e.settings.shuffleQuestions,e.settings.shuffleOptions,t]),p=d>0?Math.max(0,d-Math.floor((l-s)/1e3)):0,m=d>0&&p<=0,h=a||m;(0,P.useEffect)(()=>{if(d<=0||h)return;let e=window.setInterval(()=>u(Date.now()),500);return()=>window.clearInterval(e)},[d,h]);let g=(0,P.useMemo)(()=>O(e.description),[e.description]),_=f.filter(e=>(r[e.id]??[]).length>0).length,v=(0,P.useMemo)(()=>{let t=0,n=0,i=0;for(let e of f)n+=e.points||1,rt(e,r[e.id]??[])&&(t+=e.points||1,i+=1);let a=n>0?Math.round(t/n*100):0;return{earned:t,possible:n,correctCount:i,percent:a,passed:a>=e.settings.passMark}},[f,r,e.settings.passMark]),y=(t,n)=>{h||e.settings.instantFeedback&&(r[t.id]??[]).length>0&&t.type!==`multi`||i(e=>{let r=e[t.id]??[];if(t.type===`multi`){let i=r.includes(n)?r.filter(e=>e!==n):[...r,n];return{...e,[t.id]:i}}return{...e,[t.id]:[n]}})};return f.length===0?(0,$.jsx)(`p`,{className:M.emptyState,children:`Add a question to see the preview.`}):(0,$.jsxs)(`div`,{className:M.previewWrap,children:[(0,$.jsxs)(`div`,{className:M.previewHeader,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h2`,{className:M.previewTitle,children:e.title||`Untitled Quiz`}),e.description&&(0,$.jsx)(`div`,{className:M.previewDesc,dangerouslySetInnerHTML:{__html:g}})]}),d>0&&!h&&(0,$.jsxs)(`span`,{className:`${M.timerChip} ${p<=30?M.timerChipLow:``}`,children:[(0,$.jsx)(D,{size:15}),it(p)]})]}),(0,$.jsx)(`div`,{className:M.progressBar,children:(0,$.jsx)(`div`,{className:M.progressFill,style:{width:`${_/f.length*100}%`}})}),(0,$.jsxs)(`p`,{className:M.progressLabel,children:[_,` of `,f.length,` answered`]}),f.map((n,i)=>{let a=r[n.id]??[],o=h||e.settings.instantFeedback&&a.length>0,s=rt(n,a);return(0,$.jsxs)(`div`,{className:M.previewQuestion,children:[(0,$.jsxs)(`div`,{className:M.previewQuestionHead,children:[(0,$.jsxs)(`span`,{className:M.previewQuestionLabel,children:[`Question `,i+1]}),n.points>1&&(0,$.jsxs)(`span`,{className:M.pointsChip,children:[n.points,` pts`]}),o&&(0,$.jsx)(`span`,{className:s?M.verdictCorrect:M.verdictIncorrect,children:s?`Correct`:`Incorrect`})]}),(0,$.jsx)(`div`,{className:M.previewQuestionBody,dangerouslySetInnerHTML:{__html:O(n.text)}}),n.options.map(e=>{let r=a.includes(e.id),i=M.previewOption;return o&&e.correct?i+=` ${M.previewOptionCorrect}`:o&&r?i+=` ${M.previewOptionIncorrect}`:r&&(i+=` ${M.previewOptionChecked}`),(0,$.jsxs)(`label`,{className:i,children:[(0,$.jsx)(`input`,{type:n.type===`multi`?`checkbox`:`radio`,name:`preview-${t}-${n.id}`,checked:r,disabled:h,onChange:()=>y(n,e.id)}),(0,$.jsx)(`span`,{children:e.text||(0,$.jsx)(`em`,{children:`(empty option)`})})]},e.id)}),o&&n.explanation.trim()&&(0,$.jsxs)(`div`,{className:M.explanationBox,children:[(0,$.jsx)(w,{size:15}),(0,$.jsx)(`div`,{dangerouslySetInnerHTML:{__html:O(n.explanation)}})]})]},n.id)}),(0,$.jsx)(`div`,{className:M.previewToolbar,children:h?(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:v.passed?M.resultPass:M.resultFail,children:[(0,$.jsxs)(`strong`,{children:[v.percent,`%`]}),(0,$.jsxs)(`span`,{children:[v.earned,` / `,v.possible,` points · `,v.correctCount,` of`,` `,f.length,` correct · `,v.passed?`Passed`:`Below pass mark`,` (`,e.settings.passMark,`%)`,m&&!a?` · time up`:``]})]}),(0,$.jsxs)(`button`,{type:`button`,className:M.secondaryBtn,onClick:()=>{i({}),o(!1),n(e=>e+1),c(Date.now()),u(Date.now())},children:[(0,$.jsx)(re,{size:15}),`Retry`]})]}):(0,$.jsx)(`button`,{type:`button`,className:M.primaryStudioBtn,onClick:()=>o(!0),children:`Submit answers`})})]})}function ot({title:e,onClose:t,children:n,footer:i,width:a=460}){return(0,$.jsx)(r.div,{className:M.modalOverlay,onClick:t,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.16},children:(0,$.jsxs)(r.div,{className:M.modalPanel,style:{maxWidth:a},onClick:e=>e.stopPropagation(),initial:{opacity:0,y:14,scale:.98},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:8,scale:.98},transition:{duration:.22,ease:[.16,1,.3,1]},role:`dialog`,"aria-modal":`true`,"aria-label":e,children:[(0,$.jsxs)(`div`,{className:M.modalHeader,children:[(0,$.jsx)(`h3`,{className:M.modalTitle,children:e}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:t,"aria-label":`Close`,children:(0,$.jsx)(s,{size:18})})]}),(0,$.jsx)(`div`,{className:M.modalBody,children:n}),i&&(0,$.jsx)(`div`,{className:M.modalActions,children:i})]})})}function st({quiz:e,issues:t,onClose:n,onDownloadHtml:r,onDownloadMarkdown:i,onDownloadExcel:a}){let{errors:o,warnings:s}=qe(t),c=A(e);return(0,$.jsxs)(ot,{title:`Export quiz`,onClose:n,width:470,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`button`,{type:`button`,className:M.secondaryBtn,onClick:i,children:`.md`}),(0,$.jsx)(`button`,{type:`button`,className:M.secondaryBtn,onClick:a,children:`.xlsx`}),(0,$.jsx)(`button`,{type:`button`,className:M.primaryStudioBtn,onClick:r,children:`Download .html`})]}),children:[(0,$.jsxs)(`div`,{className:M.shareCard,children:[(0,$.jsx)(`div`,{className:M.shareCardIcon,children:(0,$.jsx)(T,{size:24})}),(0,$.jsx)(`h3`,{className:M.shareCardTitle,children:e.title||`Untitled Quiz`}),e.description&&(0,$.jsx)(`p`,{className:M.shareCardDesc,children:e.description}),(0,$.jsxs)(`div`,{className:M.shareCardStats,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:e.questions.length}),` questions`]}),(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:c}),` points`]}),(0,$.jsxs)(`span`,{children:[(0,$.jsxs)(`strong`,{children:[e.settings.passMark,`%`]}),` to pass`]}),e.settings.timeLimitMinutes>0&&(0,$.jsxs)(`span`,{children:[(0,$.jsx)(D,{size:13}),` `,(0,$.jsx)(`strong`,{children:e.settings.timeLimitMinutes}),` min`]})]})]}),(o>0||s>0)&&(0,$.jsxs)(`div`,{className:o>0?M.exportWarnError:M.exportWarn,children:[(0,$.jsx)(d,{size:15}),(0,$.jsxs)(`span`,{children:[o>0&&`${o} error${o===1?``:`s`}`,o>0&&s>0&&` · `,s>0&&`${s} warning${s===1?``:`s`}`,o>0?` — questions with no correct answer will always score as wrong.`:` — you can still export.`]})]}),(0,$.jsx)(`p`,{className:M.modalHint,children:`The .html file is fully self-contained — no server, no internet, no install. Open it anywhere or send it to someone.`})]})}function ct(e){let t=new Date(e);return Number.isNaN(t.getTime())?``:t.toLocaleString(void 0,{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`})}function lt({entries:e,currentId:t,onClose:n,onSaveCurrent:r,onOpen:i,onDelete:a,onDuplicate:s,onRename:c,onNewQuiz:u}){let[d,f]=(0,P.useState)(null),[p,m]=(0,P.useState)(``),g=()=>{d&&p.trim()&&c(d,p.trim()),f(null)};return(0,$.jsxs)(ot,{title:`My quizzes`,onClose:n,width:560,footer:(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`button`,{type:`button`,className:M.secondaryBtn,onClick:u,children:[(0,$.jsx)(x,{size:15}),`New quiz`]}),(0,$.jsxs)(`button`,{type:`button`,className:M.primaryStudioBtn,onClick:r,children:[(0,$.jsx)(h,{size:15}),`Save current quiz`]})]}),children:[e.length===0?(0,$.jsxs)(`div`,{className:M.libraryEmpty,children:[(0,$.jsx)(_,{size:28}),(0,$.jsxs)(`p`,{children:[`No saved quizzes yet. Hit `,(0,$.jsx)(`strong`,{children:`Save current quiz`}),` to keep this one and start another — they all stay in this browser.`]})]}):(0,$.jsx)(`ul`,{className:M.libraryList,children:e.map(e=>{let n=e.id===t,r=e.quiz.questions.length,c=`${r} question${r===1?``:`s`} · ${A(e.quiz)} pts · saved ${ct(e.savedAt)}`;return(0,$.jsxs)(`li`,{className:`${M.libraryRow} ${n?M.libraryRowCurrent:``}`,children:[d===e.id?(0,$.jsxs)(`div`,{className:M.libraryMain,children:[(0,$.jsx)(`input`,{autoFocus:!0,value:p,onChange:e=>m(e.target.value),onBlur:g,onKeyDown:e=>{e.key===`Enter`&&g(),e.key===`Escape`&&f(null)},className:M.libraryRenameInput}),(0,$.jsx)(`span`,{className:M.libraryMeta,children:c})]}):(0,$.jsxs)(`button`,{type:`button`,className:M.libraryMain,onClick:()=>i(e),title:`Open this quiz`,children:[(0,$.jsxs)(`span`,{className:M.libraryTitle,children:[(0,$.jsx)(`span`,{className:M.libraryTitleText,children:e.quiz.title||`Untitled Quiz`}),n&&(0,$.jsx)(`span`,{className:M.libraryCurrentTag,children:`open`})]}),(0,$.jsx)(`span`,{className:M.libraryMeta,children:c})]}),(0,$.jsxs)(`div`,{className:M.libraryActions,children:[(0,$.jsx)(`button`,{type:`button`,className:M.iconBtnSmall,title:`Rename`,onClick:()=>{f(e.id),m(e.quiz.title)},children:(0,$.jsx)(ae,{size:14})}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtnSmall,title:`Duplicate`,onClick:()=>s(e.id),children:(0,$.jsx)(l,{size:14})}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtnSmall,title:`Delete`,onClick:()=>a(e.id),children:(0,$.jsx)(o,{size:14})})]})]},e.id)})}),(0,$.jsx)(`p`,{className:M.modalHint,children:`Saved quizzes live in this browser only (localStorage) — they aren't uploaded anywhere. Use Export to get a file you can keep or share.`})]})}function ut({settings:e,onChange:t,onClose:n}){let r=n=>t({...e,[n]:!e[n]});return(0,$.jsx)(ot,{title:`Quiz settings`,onClose:n,width:480,children:(0,$.jsxs)(`div`,{className:M.settingsList,children:[(0,$.jsxs)(`label`,{className:M.settingRow,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:`Shuffle questions`}),(0,$.jsx)(`small`,{children:`Randomise question order on every attempt`})]}),(0,$.jsx)(`input`,{type:`checkbox`,checked:e.shuffleQuestions,onChange:()=>r(`shuffleQuestions`)})]}),(0,$.jsxs)(`label`,{className:M.settingRow,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:`Shuffle options`}),(0,$.jsx)(`small`,{children:`Randomise answer order within each question`})]}),(0,$.jsx)(`input`,{type:`checkbox`,checked:e.shuffleOptions,onChange:()=>r(`shuffleOptions`)})]}),(0,$.jsxs)(`label`,{className:M.settingRow,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:`Instant feedback`}),(0,$.jsx)(`small`,{children:`Reveal the answer and explanation as soon as it's picked`})]}),(0,$.jsx)(`input`,{type:`checkbox`,checked:e.instantFeedback,onChange:()=>r(`instantFeedback`)})]}),(0,$.jsxs)(`label`,{className:M.settingRow,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:`Pass mark`}),(0,$.jsx)(`small`,{children:`Minimum score to pass`})]}),(0,$.jsxs)(`span`,{className:M.settingInputWrap,children:[(0,$.jsx)(`input`,{type:`number`,min:0,max:100,value:e.passMark,onChange:n=>t({...e,passMark:Math.min(100,Math.max(0,Number(n.target.value)||0))}),className:M.numberInput}),`%`]})]}),(0,$.jsxs)(`label`,{className:M.settingRow,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:`Time limit`}),(0,$.jsx)(`small`,{children:`0 means no limit`})]}),(0,$.jsxs)(`span`,{className:M.settingInputWrap,children:[(0,$.jsx)(`input`,{type:`number`,min:0,value:e.timeLimitMinutes,onChange:n=>t({...e,timeLimitMinutes:Math.max(0,Number(n.target.value)||0)}),className:M.numberInput}),`min`]})]}),(0,$.jsxs)(`label`,{className:M.settingRow,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:`Exported file theme`}),(0,$.jsx)(`small`,{children:`Appearance of the downloaded .html quiz`})]}),(0,$.jsxs)(`select`,{value:e.theme,onChange:n=>t({...e,theme:n.target.value}),className:M.select,children:[(0,$.jsx)(`option`,{value:`light`,children:`Light`}),(0,$.jsx)(`option`,{value:`dark`,children:`Dark`})]})]})]})})}function dt({onClose:e}){return(0,$.jsx)(ot,{title:`Keyboard shortcuts`,onClose:e,width:420,children:(0,$.jsx)(`ul`,{className:M.shortcutList,children:Je.map(e=>(0,$.jsxs)(`li`,{className:M.shortcutRow,children:[(0,$.jsx)(`span`,{children:e.label}),(0,$.jsx)(`kbd`,{className:M.kbd,children:e.keys})]},e.keys))})})}var ft={success:p,error:d,info:S},pt={success:M.toastSuccess,error:M.toastError,info:M.toastInfo};function mt({toasts:e,onDismiss:t}){return(0,$.jsx)(`div`,{className:M.toastStack,children:(0,$.jsx)(ce,{initial:!1,children:e.map(e=>{let n=ft[e.kind];return(0,$.jsxs)(r.button,{type:`button`,onClick:()=>t(e.id),className:`${M.toast} ${pt[e.kind]}`,initial:{opacity:0,y:12,scale:.96},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:8,scale:.96},transition:{duration:.22,ease:[.16,1,.3,1]},children:[(0,$.jsx)(n,{size:17}),(0,$.jsx)(`span`,{children:e.message})]},e.id)})})})}function ht(e,t){let n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=e,r.click(),URL.revokeObjectURL(n)}function gt(e,t,n){ht(e,new Blob([t],{type:n}))}function _t(e){return e.toLowerCase().trim().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`quiz`}function vt(){let[e,t]=(0,P.useState)(()=>ve()??V(Ee)),[n,o]=(0,P.useState)(null),[c,l]=(0,P.useState)(`edit`),[u,f]=(0,P.useState)(null),[m,g]=(0,P.useState)(!1),_=be(`(max-width: 860px)`),[v,b]=(0,P.useState)(null),[te,re]=(0,P.useState)(null),[ae,S]=(0,P.useState)(!1),[C,w]=(0,P.useState)(()=>Z()),[T,E]=(0,P.useState)(null),[D,O]=(0,P.useState)(null),k=(0,P.useRef)(null),A=(0,P.useRef)(!1),{toasts:j,pushToast:N,dismissToast:Se}=xe();(0,P.useEffect)(()=>{A.current||(A.current=!0,ve()&&N(`Restored your last draft`,`info`))},[N]),(0,P.useEffect)(()=>{let t=window.setTimeout(()=>{he(e),re(new Date)},600);return()=>window.clearTimeout(t)},[e]),(0,P.useEffect)(()=>{if(D===null)return;let e=window.setTimeout(()=>{let e=V(D);e.questions.length>0&&t(e)},500);return()=>window.clearTimeout(e)},[D]);let F=t=>{O(t===`markdown`?Te(e):null),l(t)},I=(0,P.useMemo)(()=>D===null?0:V(D).questions.length,[D]),L=(0,P.useMemo)(()=>Ke(e),[e]),Ce=(0,P.useMemo)(()=>qe(L),[L]),R=n&&e.questions.some(e=>e.id===n)?n:e.questions[0]?.id??null,z=e.questions.findIndex(e=>e.id===R),B=z>=0?e.questions[z]:null,we=(e,n)=>t(t=>({...t,questions:t.questions.map(t=>t.id===e?n:t)})),H=(0,P.useCallback)(()=>{let e=ye();t(t=>({...t,questions:[...t.questions,e]})),o(e.id),b(e.id),l(e=>e===`preview`?`edit`:e),N(`Question added`)},[N]),De=e=>{t(t=>({...t,questions:t.questions.filter(t=>t.id!==e)})),N(`Question deleted`)},Oe=(0,P.useCallback)(n=>{let r=e.questions.find(e=>e.id===n);if(!r)return;let i=_e(r);t(e=>{let t=e.questions.findIndex(e=>e.id===n),r=[...e.questions];return r.splice(t+1,0,i),{...e,questions:r}}),o(i.id),b(i.id),N(`Question duplicated`)},[e.questions,N]),Ae=(0,P.useCallback)(()=>{B&&Oe(B.id)},[B,Oe]),je=(0,P.useCallback)((e,n)=>{t(t=>{if(e===n||e<0||n<0||e>=t.questions.length||n>=t.questions.length)return t;let r=[...t.questions],[i]=r.splice(e,1);return r.splice(n,0,i),{...t,questions:r}})},[]),U=(0,P.useCallback)((e,n)=>{t(t=>{let r=t.questions.findIndex(t=>t.id===e),i=r+n;if(r<0||i<0||i>=t.questions.length)return t;let a=[...t.questions];return[a[r],a[i]]=[a[i],a[r]],{...t,questions:a}})},[]),W=(0,P.useCallback)(e=>{R&&U(R,e)},[R,U]),G=t=>{let n=z+t;n<0||n>=e.questions.length||(o(e.questions[n].id),l(e=>e===`preview`?`edit`:e))},Me=(0,P.useCallback)((e,n)=>{let r=V(e);if(r.questions.length===0){N(`No questions found in that file`,`error`);return}t(r),o(r.questions[0].id),N(`Loaded ${r.questions.length} questions from ${n}`)},[N]),K=(0,P.useCallback)(async e=>{try{let n=await Re(e);if(n.questions.length===0){N(`No questions found — check the sheet names and headers`,`error`);return}t(n),o(n.questions[0].id),E(null),N(`Loaded ${n.questions.length} questions from ${e.name}`)}catch{N(`Couldn't read that spreadsheet`,`error`)}},[N]),q=(0,P.useCallback)(async e=>{if(/\.(xlsx|xlsm|xls)$/i.test(e.name)){await K(e);return}Me(await e.text(),e.name)},[K,Me]),J=async()=>{ht(`quiz-template.xlsx`,await ze()),N(`Excel template downloaded`)},Ne=async e=>{let t=e.target.files?.[0];e.target.value=``,t&&await q(t)},Pe=e=>Array.from(e.dataTransfer.types??[]).includes(`Files`),Fe=async e=>{if(!Pe(e))return;e.preventDefault(),S(!1);let t=e.dataTransfer.files?.[0];if(t){if(!/\.(md|markdown|txt|xlsx|xlsm|xls)$/i.test(t.name)){N(`Drop a .md or .xlsx file`,`error`);return}await q(t)}},Ie=(0,P.useCallback)(()=>{gt(`${_t(e.title)}.md`,Te(e),`text/markdown`),N(`Saved as .md`)},[e,N]),Le=(0,P.useCallback)(async()=>{ht(`${_t(e.title)}.xlsx`,await ze(e)),N(`Quiz exported as .xlsx`)},[e,N]),Be=(0,P.useCallback)(()=>{gt(`${_t(e.title)}.html`,ke(e),`text/html`),f(null),N(`Quiz exported as .html`)},[e,N]),Ve=()=>{let e=V(Ee);t(e),o(e.questions[0]?.id??null),N(`Example quiz loaded`,`info`)},Y=e=>e.title.trim()!==`Untitled Quiz`||e.questions.some(e=>e.text.trim()),X=e=>Te(e)===Te(V(Ee)),Q=()=>w(Z()),Je=(0,P.useCallback)(()=>{if(!T&&(!Y(e)||X(e)))return!1;let t=He(e,T);return t&&E(t.id),!!t},[e,T]),Ye=(0,P.useCallback)(()=>{let t=He(e,T);if(!t){N(`Couldn't save — browser storage is full or blocked`,`error`);return}E(t.id),w(Z()),N(`Saved "${e.title||`Untitled Quiz`}" to your quizzes`)},[e,T,N]),Qe=e=>{let n=e.id!==T&&Je();t(e.quiz),o(e.quiz.questions[0]?.id??null),E(e.id),w(Z()),f(null);let r=e.quiz.title||`Untitled Quiz`;N(n?`Opened "${r}" — previous quiz saved`:`Opened "${r}"`)},tt=(0,P.useCallback)(()=>{let e=Je(),n=me();ge(),t(n),o(n.questions[0]?.id??null),E(null),w(Z()),f(null),N(e?`Previous quiz kept in your quizzes`:`New blank quiz`,`info`)},[Je,N]);return Xe({onSave:Ye,onDownloadMarkdown:Ie,onOpenLibrary:()=>f(`library`),onExport:()=>f(`export`),onTogglePreview:()=>F(c===`preview`?`edit`:`preview`),onToggleMarkdown:()=>F(c===`markdown`?`edit`:`markdown`),onNewQuestion:H,onDuplicate:Ae,onMoveUp:()=>W(-1),onMoveDown:()=>W(1),onPrevQuestion:()=>G(-1),onNextQuestion:()=>G(1),onHelp:()=>f(`shortcuts`),onCloseOverlay:()=>{f(null),g(!1)}}),(0,$.jsxs)(`div`,{className:M.studio,onDragOver:e=>{Pe(e)&&(e.preventDefault(),S(!0))},onDragLeave:()=>S(!1),onDrop:Fe,children:[(0,$.jsxs)(`header`,{className:M.topbar,children:[(0,$.jsx)(`button`,{type:`button`,className:`${M.iconBtn} ${M.menuToggle}`,onClick:()=>g(e=>!e),"aria-label":`Toggle sidebar`,children:m?(0,$.jsx)(s,{size:20}):(0,$.jsx)(y,{size:20})}),(0,$.jsxs)(i,{to:`/`,className:M.exitLink,title:`Back to imango.in`,children:[(0,$.jsx)(oe,{size:15}),(0,$.jsx)(ie,{size:19})]}),(0,$.jsx)(`span`,{className:M.topbarDivider}),(0,$.jsx)(`span`,{className:M.topbarTitle,children:`Quiz Studio`}),(0,$.jsx)(`span`,{className:M.saveState,children:Ce.errors>0?(0,$.jsxs)(`span`,{className:M.saveStateWarn,children:[(0,$.jsx)(d,{size:14}),Ce.errors,` to fix`]}):te?(0,$.jsxs)(`span`,{className:M.saveStateOk,children:[(0,$.jsx)(p,{size:14}),`Saved`]}):null}),(0,$.jsxs)(`div`,{className:M.topbarActions,children:[(0,$.jsxs)(`button`,{type:`button`,className:M.secondaryBtn,onClick:()=>f(`library`),title:`My quizzes (Ctrl/⌘ + O)`,children:[(0,$.jsx)(ue,{size:15}),(0,$.jsxs)(`span`,{className:M.btnLabel,children:[`My quizzes`,C.length>0?` (${C.length})`:``]})]}),(0,$.jsxs)(`button`,{type:`button`,className:M.secondaryBtn,onClick:Ye,title:`Save quiz to this browser (Ctrl/⌘ + S)`,children:[(0,$.jsx)(h,{size:15}),(0,$.jsx)(`span`,{className:M.btnLabel,children:`Save`})]}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:()=>f(`settings`),title:`Quiz settings`,children:(0,$.jsx)(ee,{size:18})}),(0,$.jsx)(`button`,{type:`button`,className:M.iconBtn,onClick:()=>f(`shortcuts`),title:`Keyboard shortcuts (?)`,children:(0,$.jsx)(de,{size:18})}),(0,$.jsx)(fe,{}),(0,$.jsxs)(`button`,{type:`button`,className:M.primaryStudioBtn,onClick:()=>f(`export`),disabled:e.questions.length===0,children:[(0,$.jsx)(se,{size:15}),(0,$.jsx)(`span`,{className:M.btnLabel,children:`Export`})]})]})]}),(0,$.jsxs)(`div`,{className:M.body,children:[(0,$.jsxs)(`aside`,{className:`${M.sidebar} ${m?M.sidebarOpen:``}`,children:[(0,$.jsx)(Ze,{quiz:e,selectedId:R,issues:L,onSelect:e=>{o(e),b(e),g(!1),l(e=>e===`preview`?`edit`:e)},onAddQuestion:H,onDownloadSample:()=>gt(`sample-quiz.md`,Ee,`text/markdown`),onDownloadExcelTemplate:J,onUploadClick:()=>k.current?.click(),onLoadSample:Ve,onReorder:je}),(0,$.jsx)(`div`,{className:M.sidebarFooter,children:(0,$.jsxs)(`button`,{type:`button`,className:M.sidebarBtn,onClick:tt,children:[(0,$.jsx)(x,{size:15}),`New quiz`]})})]}),m&&(0,$.jsx)(`div`,{className:M.scrim,onClick:()=>g(!1)}),(0,$.jsxs)(`main`,{className:M.main,children:[(0,$.jsxs)(`div`,{className:M.mainToolbar,children:[(0,$.jsxs)(`div`,{className:M.modeSwitch,children:[(0,$.jsxs)(`button`,{type:`button`,className:`${M.modeBtn} ${c===`edit`?M.modeBtnActive:``}`,onClick:()=>F(`edit`),children:[(0,$.jsx)(le,{size:15}),(0,$.jsx)(`span`,{className:M.btnLabel,children:`Edit`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`${M.modeBtn} ${c===`markdown`?M.modeBtnActive:``}`,onClick:()=>F(`markdown`),title:`Edit the raw .md source (Ctrl/⌘ + M)`,children:[(0,$.jsx)(a,{size:15}),(0,$.jsx)(`span`,{className:M.btnLabel,children:`Markdown`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`${M.modeBtn} ${c===`split`?M.modeBtnActive:``} ${M.splitOnly}`,onClick:()=>F(`split`),children:[(0,$.jsx)(pe,{size:15}),(0,$.jsx)(`span`,{className:M.btnLabel,children:`Split`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`${M.modeBtn} ${c===`preview`?M.modeBtnActive:``}`,onClick:()=>F(`preview`),children:[(0,$.jsx)(ne,{size:15}),(0,$.jsx)(`span`,{className:M.btnLabel,children:`Preview`})]})]}),(0,$.jsx)(`div`,{className:M.mainToolbarActions,children:(0,$.jsx)(`button`,{type:`button`,className:M.secondaryBtn,onClick:Ie,children:`Save .md`})})]}),(0,$.jsxs)(`div`,{className:`${M.panes} ${c===`split`?M.panesSplit:M.panesSingle}`,children:[c===`markdown`&&D!==null&&(0,$.jsxs)(`section`,{className:`${M.pane} ${M.markdownPane}`,children:[(0,$.jsxs)(`div`,{className:M.markdownBar,children:[(0,$.jsxs)(`span`,{className:M.fieldLabelText,children:[(0,$.jsx)(a,{size:14}),`Markdown source`]}),(0,$.jsx)(`span`,{className:I>0?M.markdownOk:M.markdownWarn,children:I>0?`${I} question${I===1?``:`s`} detected`:`No questions detected — changes won't be applied`})]}),(0,$.jsx)(`textarea`,{value:D,onChange:e=>O(e.target.value),spellCheck:!1,className:M.markdownTextarea,"aria-label":`Quiz markdown source`}),(0,$.jsxs)(`p`,{className:M.markdownHint,children:[`Edits apply automatically. `,(0,$.jsx)(`code`,{children:`## question`}),` ·`,` `,(0,$.jsx)(`code`,{children:`- [x] correct`}),` / `,(0,$.jsx)(`code`,{children:`- [ ] wrong`}),` ·`,` `,(0,$.jsx)(`code`,{children:`> explanation`}),` · settings live in the`,` `,(0,$.jsx)(`code`,{children:`---`}),` block at the top.`]})]}),(c===`edit`||c===`split`)&&(0,$.jsxs)(`section`,{className:M.pane,children:[(0,$.jsxs)(`div`,{className:M.quizMetaFields,children:[(0,$.jsx)(`input`,{type:`text`,value:e.title,onChange:e=>t(t=>({...t,title:e.target.value})),placeholder:`Quiz title`,className:M.titleInput}),(0,$.jsx)(`textarea`,{value:e.description,onChange:e=>t(t=>({...t,description:e.target.value})),placeholder:`Short description (optional)`,className:M.descTextarea})]}),e.questions.length===0?(0,$.jsxs)(`div`,{className:M.emptyPanel,children:[(0,$.jsx)(`p`,{children:`No questions yet.`}),(0,$.jsx)(`button`,{type:`button`,className:M.primaryStudioBtn,onClick:H,children:`Add your first question`})]}):_?(0,$.jsx)(et,{quiz:e,issues:L,expandedId:v,onToggle:e=>b(t=>t===e?null:e),onChange:we,onDelete:De,onDuplicate:Oe,onMove:U,onAddQuestion:H}):B&&(0,$.jsx)($e,{question:B,index:z,total:e.questions.length,onChange:e=>we(B.id,e),onDelete:()=>De(B.id),onDuplicate:Ae,onMove:W,onNavigate:G},B.id)]}),(c===`preview`||c===`split`)&&(0,$.jsx)(`section`,{className:`${M.pane} ${M.previewPane}`,children:(0,$.jsx)(at,{quiz:e})})]})]})]}),(0,$.jsx)(`input`,{ref:k,type:`file`,accept:`.md,.markdown,.txt,.xlsx,.xlsm,.xls,text/markdown`,className:M.hiddenInput,onChange:Ne}),(0,$.jsx)(ce,{children:ae&&(0,$.jsx)(r.div,{className:M.dropZone,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:`Drop a .md or Excel file to load it`})}),(0,$.jsxs)(ce,{children:[u===`export`&&(0,$.jsx)(st,{quiz:e,issues:L,onClose:()=>f(null),onDownloadHtml:Be,onDownloadMarkdown:Ie,onDownloadExcel:Le},`export`),u===`settings`&&(0,$.jsx)(ut,{settings:e.settings,onChange:e=>t(t=>({...t,settings:e})),onClose:()=>f(null)},`settings`),u===`library`&&(0,$.jsx)(lt,{entries:C,currentId:T,onClose:()=>f(null),onSaveCurrent:Ye,onOpen:Qe,onDelete:e=>{let t=C.find(t=>t.id===e)?.quiz.title||`this quiz`;window.confirm(`Delete "${t}" from your saved quizzes? This can't be undone.`)&&(Ue(e),e===T&&E(null),Q(),N(`Quiz deleted`))},onDuplicate:e=>{if(!We(e)){N(`Couldn't duplicate — browser storage is full or blocked`,`error`);return}Q(),N(`Quiz duplicated`)},onRename:(e,n)=>{Ge(e,n),e===T&&t(e=>({...e,title:n})),Q(),N(`Renamed`)},onNewQuiz:tt},`library`),u===`shortcuts`&&(0,$.jsx)(dt,{onClose:()=>f(null)},`shortcuts`)]}),(0,$.jsx)(mt,{toasts:j,onDismiss:Se})]})}export{vt as QuizStudioPage};