import{i as e,n as t,t as n}from"./jsx-runtime-Dk72oS4N.js";import{D as r,d as i,h as a,n as o,r as s,s as c,t as l}from"./index-RVLWTxOE.js";var u=e(t(),1),d=[{id:`stripe`,name:`Stripe`,provider:`Stripe, Inc.`,category:`Payments`,description:`Accept payments, manage subscriptions, and handle payouts with a fully documented REST API.`,pricing:`Pay per transaction`,docsUrl:`https://stripe.com/docs/api`,examples:{javascript:`import Stripe from "stripe";
...
var records = await http.GetFromJsonAsync<JsonElement>(
    "https://api.airtable.com/v0/appXXXXXXXX/Candidates?maxRecords=20&view=Active");`}}];async function f(){return d}function p(){let[e,t]=(0,u.useState)([]),[n,r]=(0,u.useState)(!0),[i,a]=(0,u.useState)(null);return(0,u.useEffect)(()=>{let e=!1;return f().then(n=>{e||t(n)}).catch(()=>{e||a(`Unable to load API listings right now.`)}).finally(()=>{e||r(!1)}),()=>{e=!0}},[]),{listings:e,loading:n,error:i}}var m=[{id:`javascript`,label:`JavaScript`},{id:`python`,label:`Python`},{id:`java`,label:`Java`},{id:`csharp`,label:`C#`}],h={page:`_page_1n84h_1`,status:`_status_1n84h_5`,controls:`_controls_1n84h_11`,searchWrap:`_searchWrap_1n84h_20`,searchIcon:`_searchIcon_1n84h_26`,searchInput:`_searchInput_1n84h_35`,chips:`_chips_1n84h_55`,chip:`_chip_1n84h_55`,chipActive:`_chipActive_1n84h_79`,grid:`_grid_1n84h_85`,card:`_card_1n84h_92`,cardHeader:`_cardHeader_1n84h_110`,category:`_category_1n84h_119`,pricing:`_pricing_1n84h_130`,provider:`_provider_1n84h_140`,description:`_description_1n84h_146`,exampleHeader:`_exampleHeader_1n84h_151`,langTabs:`_langTabs_1n84h_161`,langTab:`_langTab_1n84h_161`,langTabActive:`_langTabActive_1n84h_187`,exampleLabel:`_exampleLabel_1n84h_196`,copyBtn:`_copyBtn_1n84h_204`,code:`_code_1n84h_223`,link:`_link_1n84h_242`},g=n();function _({api:e,language:t,onLanguageChange:n}){let[r,o]=(0,u.useState)(!1),l=e.examples[t];return(0,g.jsxs)(s,{className:h.card,children:[(0,g.jsxs)(`div`,{className:h.cardHeader,children:[(0,g.jsx)(`span`,{className:h.category,children:e.category}),(0,g.jsx)(`span`,{className:h.pricing,children:e.pricing})]}),(0,g.jsx)(`h3`,{children:e.name}),(0,g.jsx)(`p`,{className:h.provider,children:e.provider}),(0,g.jsx)(`p`,{className:h.description,children:e.description}),(0,g.jsxs)(`div`,{className:h.exampleHeader,children:[(0,g.jsx)(`div`,{className:h.langTabs,role:`tablist`,"aria-label":`Code language`,children:m.map(e=>(0,g.jsx)(`button`,{type:`button`,role:`tab`,"aria-selected":t===e.id,className:`${h.langTab} ${t===e.id?h.langTabActive:``}`,onClick:()=>n(e.id),children:e.label},e.id))}),(0,g.jsxs)(`button`,{type:`button`,className:h.copyBtn,onClick:async()=>{try{await navigator.clipboard.writeText(l),o(!0),setTimeout(()=>o(!1),1800)}catch{}},children:[r?(0,g.jsx)(i,{size:14}):(0,g.jsx)(a,{size:14}),r?`Copied`:`Copy`]})]}),(0,g.jsx)(`pre`,{className:h.code,children:(0,g.jsx)(`code`,{children:l})}),(0,g.jsxs)(`a`,{href:e.docsUrl,target:`_blank`,rel:`noreferrer`,className:h.link,children:[`View docs`,(0,g.jsx)(c,{size:16})]})]})}var v=`imango-marketplace-language`;function y(){try{let e=localStorage.getItem(v);if(m.some(t=>t.id===e))return e}catch{}return`javascript`}function b(){let{listings:e,loading:t,error:n}=p(),[i,a]=(0,u.useState)(``),[s,c]=(0,u.useState)(`All`),[d,f]=(0,u.useState)(y),m=e=>{f(e);try{localStorage.setItem(v,e)}catch{}},b=(0,u.useMemo)(()=>[`All`,...Array.from(new Set(e.map(e=>e.category)))],[e]),x=(0,u.useMemo)(()=>{let t=i.trim().toLowerCase();return e.filter(e=>{let n=s===`All`||e.category===s,r=t===``||e.name.toLowerCase().includes(t)||e.description.toLowerCase().includes(t);return n&&r})},[e,s,i]);return(0,g.jsx)(`section`,{id:`marketplace`,className:h.page,children:(0,g.jsxs)(`div`,{className:`container`,children:[(0,g.jsx)(l,{eyebrow:`API Marketplace`,title:`Discover the best APIs, ready to use.`,description:`A curated directory of powerful APIs, what they offer, and how to call them. Developer listings and direct connections are coming soon.`}),!t&&!n&&e.length>0&&(0,g.jsxs)(`div`,{className:h.controls,children:[(0,g.jsxs)(`div`,{className:h.searchWrap,children:[(0,g.jsx)(r,{size:18,className:h.searchIcon}),(0,g.jsx)(`input`,{type:`text`,value:i,onChange:e=>a(e.target.value),placeholder:`Search APIs by name or description...`,className:h.searchInput,"aria-label":`Search APIs`})]}),(0,g.jsx)(`div`,{className:h.chips,children:b.map(e=>(0,g.jsx)(`button`,{type:`button`,onClick:()=>c(e),className:`${h.chip} ${s===e?h.chipActive:``}`,children:e},e))})]}),t&&(0,g.jsx)(`p`,{className:h.status,children:`Loading APIs...`}),n&&(0,g.jsx)(`p`,{className:h.status,children:n}),!t&&!n&&x.length===0&&(0,g.jsx)(`p`,{className:h.status,children:`No APIs match your search.`}),!t&&!n&&x.length>0&&(0,g.jsx)(o,{className:h.grid,stagger:.08,children:x.map(e=>(0,g.jsx)(_,{api:e,language:d,onLanguageChange:m},e.id))})]})})}export{b as MarketplacePage};