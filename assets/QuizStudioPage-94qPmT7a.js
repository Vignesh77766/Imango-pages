import{i as e,n as t,t as n}from"./jsx-runtime-Dk72oS4N.js";import{t as r}from"./proxy-eqDMOVHJ.js";import{$ as i,B as a,Ct as o,D as s,Et as c,G as l,I as u,J as d,Jt as f,L as p,M as m,Mt as h,Nt as g,O as _,Q as v,R as y,Rt as b,St as x,Tt as ee,U as S,Vt as te,W as ne,Y as re,Z as ie,c as ae,ct as oe,ft as se,kt as ce,l as le,q as C,rt as w,s as ue,v as de,vt as T,wt as fe,y as E,yt as pe,z as D}from"./index-C3yzpHau.js";import{t as O}from"./renderMarkdown-_QdSbiZv.js";import{n as me,t as he}from"./useMediaQuery-DzCNKdWO.js";import{a as k,c as ge,d as A,i as _e,l as j,n as ve,o as ye,r as be,s as xe,t as M,u as N}from"./QuizStudioPage.module-S5mpNvcD.js";var P=e(t(),1),Se=/^\s*-\s*\[([ xX])\]\s*(.*)$/,F=/^#\s+(.*)$/,I=/^##\s+(.*)$/,L=/^\s*<!--\s*points:\s*(\d+)\s*-->\s*$/,Ce=/^\s*>\s?(.*)$/,R=/^\s*(```|~~~)/,z=/^---\s*$/;function B(e){if(e.length===2){let t=e.map(e=>e.text.trim().toLowerCase()).sort();if(t[0]===`false`&&t[1]===`true`)return`boolean`}return e.filter(e=>e.correct).length>1?`multi`:`single`}function we(e){let t={...k};if(e.length===0||!z.test(e[0]))return{settings:t,nextIndex:0};let n=1;for(;n<e.length&&!z.test(e[n]);){let r=e[n].indexOf(`:`);if(r>0){let i=e[n].slice(0,r).trim(),a=e[n].slice(r+1).trim();switch(i){case`shuffleQuestions`:t.shuffleQuestions=a===`true`;break;case`shuffleOptions`:t.shuffleOptions=a===`true`;break;case`instantFeedback`:t.instantFeedback=a===`true`;break;case`passMark`:t.passMark=Number.isFinite(Number(a))?Number(a):k.passMark;break;case`timeLimitMinutes`:t.timeLimitMinutes=Number.isFinite(Number(a))?Number(a):0;break;case`theme`:t.theme=a===`dark`?`dark`:`light`}}n+=1}return{settings:t,nextIndex:Math.min(n+1,e.length)}}function V(e){let t=e.replace(/\r\n/g,`
`).split(`
