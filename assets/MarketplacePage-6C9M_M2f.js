import{a as e,n as t,t as n}from"./jsx-runtime-D3jfb0Ew.js";import{L as r,at as i,i as a,j as o,r as s,t as c,x as l}from"./index-D8gsPGH8.js";var u=e(t(),1),d=[{id:`stripe`,name:`Stripe`,provider:`Stripe, Inc.`,category:`Payments`,description:`Accept payments, manage subscriptions, and handle payouts with a fully documented REST API.`,pricing:`Pay per transaction`,docsUrl:`https://stripe.com/docs/api`,examples:{javascript:`import Stripe from "stripe";
...
`).toLowerCase(),i=0;for(let a of n){let n=v(e,a,r);if(n===0)return{api:e,index:t,total:0};i+=n}return{api:e,index:t,total:i}}).filter(e=>e.total>0).sort((e,t)=>t.total-e.total||e.index-t.index).map(e=>e.api)}var b={page:`_page_1n84h_1`,status:`_status_1n84h_5`,controls:`_controls_1n84h_11`,searchWrap:`_searchWrap_1n84h_20`,searchIcon:`_searchIcon_1n84h_26`,searchInput:`_searchInput_1n84h_35`,chips:`_chips_1n84h_55`,chip:`_chip_1n84h_55`,chipActive:`_chipActive_1n84h_79`,grid:`_grid_1n84h_85`,card:`_card_1n84h_92`,cardHeader:`_cardHeader_1n84h_110`,category:`_category_1n84h_119`,pricing:`_pricing_1n84h_130`,provider:`_provider_1n84h_140`,description:`_description_1n84h_146`,exampleHeader:`_exampleHeader_1n84h_151`,langTabs:`_langTabs_1n84h_161`,langTab:`_langTab_1n84h_161`,langTabActive:`_langTabActive_1n84h_187`,exampleLabel:`_exampleLabel_1n84h_196`,copyBtn:`_copyBtn_1n84h_204`,code:`_code_1n84h_223`,link:`_link_1n84h_242`},x=n();function S({api:e,language:t,onLanguageChange:n}){let[i,s]=(0,u.useState)(!1),c=e.examples[t];return(0,x.jsxs)(a,{className:b.card,children:[(0,x.jsxs)(`div`,{className:b.cardHeader,children:[(0,x.jsx)(`span`,{className:b.category,children:e.category}),(0,x.jsx)(`span`,{className:b.pricing,children:e.pricing})]}),(0,x.jsx)(`h3`,{children:e.name}),(0,x.jsx)(`p`,{className:b.provider,children:e.provider}),(0,x.jsx)(`p`,{className:b.description,children:e.description}),(0,x.jsxs)(`div`,{className:b.exampleHeader,children:[(0,x.jsx)(`div`,{className:b.langTabs,role:`tablist`,"aria-label":`Code language`,children:m.map(e=>(0,x.jsx)(`button`,{type:`button`,role:`tab`,"aria-selected":t===e.id,className:`${b.langTab} ${t===e.id?b.langTabActive:``}`,onClick:()=>n(e.id),children:e.label},e.id))}),(0,x.jsxs)(`button`,{type:`button`,className:b.copyBtn,onClick:async()=>{try{await navigator.clipboard.writeText(c),s(!0),setTimeout(()=>s(!1),1800)}catch{}},children:[i?(0,x.jsx)(o,{size:14}):(0,x.jsx)(r,{size:14}),i?`Copied`:`Copy`]})]}),(0,x.jsx)(`pre`,{className:b.code,children:(0,x.jsx)(`code`,{children:c})}),(0,x.jsxs)(`a`,{href:e.docsUrl,target:`_blank`,rel:`noreferrer`,className:b.link,children:[`View docs`,(0,x.jsx)(l,{size:16})]})]})}var C=`imango-marketplace-language`;function w(){try{let e=localStorage.getItem(C);if(m.some(t=>t.id===e))return e}catch{}return`javascript`}function T(){let{listings:e,loading:t,error:n}=p(),[r,a]=(0,u.useState)(``),[o,l]=(0,u.useState)(`All`),[d,f]=(0,u.useState)(w),m=e=>{f(e);try{localStorage.setItem(C,e)}catch{}},h=(0,u.useMemo)(()=>[`All`,...Array.from(new Set(e.map(e=>e.category)))],[e]),g=(0,u.useMemo)(()=>y(o===`All`?e:e.filter(e=>e.category===o),r),[e,o,r]);return(0,x.jsx)(`section`,{id:`marketplace`,className:b.page,children:(0,x.jsxs)(`div`,{className:`container`,children:[(0,x.jsx)(c,{eyebrow:`API Marketplace`,title:`Discover the best APIs, ready to use.`,description:`A curated directory of powerful APIs, what they offer, and how to call them. Developer listings and direct connections are coming soon.`}),!t&&!n&&e.length>0&&(0,x.jsxs)(`div`,{className:b.controls,children:[(0,x.jsxs)(`div`,{className:b.searchWrap,children:[(0,x.jsx)(i,{size:18,className:b.searchIcon}),(0,x.jsx)(`input`,{type:`text`,value:r,onChange:e=>a(e.target.value),placeholder:`Search APIs by name or description...`,className:b.searchInput,"aria-label":`Search APIs`})]}),(0,x.jsx)(`div`,{className:b.chips,children:h.map(e=>(0,x.jsx)(`button`,{type:`button`,onClick:()=>l(e),className:`${b.chip} ${o===e?b.chipActive:``}`,children:e},e))})]}),t&&(0,x.jsx)(`p`,{className:b.status,children:`Loading APIs...`}),n&&(0,x.jsx)(`p`,{className:b.status,children:n}),!t&&!n&&g.length===0&&(0,x.jsx)(`p`,{className:b.status,children:`No APIs match your search.`}),!t&&!n&&g.length>0&&(0,x.jsx)(s,{className:b.grid,stagger:.04,trigger:`mount`,children:g.map(e=>(0,x.jsx)(S,{api:e,language:d,onLanguageChange:m},e.id))})]})})}export{T as MarketplacePage};